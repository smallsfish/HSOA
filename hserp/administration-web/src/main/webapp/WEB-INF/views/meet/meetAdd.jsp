...
<body>
<div class='mt'>
    <form class="layui-form" id="meetAdd">
        ...
        <div class="layui-form-item">
            <div class="layui-input-inline sub" style="margin-left: 150px;">
                <button class="layui-btn" lay-submit="" lay-filter="meetAdd">立即提交</button>
...
<script>
    ...
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(meetAdd)', function (data) {
            ...
            var fromData = new FormData($("#meetAdd")[0]);

            $.ajax({
                type: "POST",
                dataType: "json",
                url: 'system/meeting/api/meetingAdd',
                data: fromData,
                async: false,
                cache: false,
                contentType: false,
    ...
    //不可以输入
    $("input[name='participateNumber']").keyup(function(){
        var tmptxt=$(this).val();
    ...
    $("input[name='shouldparticipateNumber']").keyup(function(){
        var tmptxt=$(this).val();
        $(this).val(tmptxt.replace(/[^0-9.]/g,''));
    }).bind("paste",function(){
        var tmptxt=$(this).val();
    ...
    $("input[name='realparticipateNumber']").keyup(function(){
        var tmptxt=$(this).val();
        $(this).val(tmptxt.replace(/[^0-9.]/g,''));
    }).bind("paste",function(){
        var tmptxt=$(this).val();

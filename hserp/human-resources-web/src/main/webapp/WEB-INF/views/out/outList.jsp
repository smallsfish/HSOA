...
<script>
    ...
    layui.use('table', function(){
        ...
        layui.use(['element', 'table'], function () {
            ...
            elem: '#test'
            ,url:'system/human/api/getOutEmpList'
            ,height: 'full-78'
            ,cols: [[
                ...
                ,{field:'outTime', width: twidth*0.1, title: '离职时间', sort: true, align: 'center'}
                 ,{field:'reason', width: twidth*0.1, title: '离职原因', sort: true, align: 'center'}
                ,{
                    width: twidth * 0.18,
                    fixed: 'right',
                    align: 'center',
                ...
                if (layEvent === 'del') {
                    layer.confirm('确认删除？', function (index) {
                        ...
                        $.ajax({
                            type: "GET",
                            dataType: "json",
                            url: 'system/human/api/deleteOutEmp',
                            data: {'id': data.id},
    ...
    function searchSubmit() {
        ...
        searchTable.reload({
            url: 'system/human/api/getOutEmpList?name=' + userName
        });
    }
    ...
    function editorUser(data) {
        layui.use('layer', function () {
            ...
            outId = data.id;
            outDept = data.deptName;
            layer.open({
                title: data.name + ' 用户编辑',
                type: 2,
                area: ['50%', '70%'],
                content: 'out/outEdit?id=' + data.id,
            });
        });
    }
    function addEva() {

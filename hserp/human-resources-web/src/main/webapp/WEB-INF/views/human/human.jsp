...
<script>
    var humanId=null,humanDept=null;
    var searchTable;
    ...
    layui.use('table', function(){
        ...
        layui.use(['element', 'table'], function () {
            ...
            ,cols: [[
                ...
                ,{field:'status', width: twidth*0.1, title: '在职状态', sort: true, align: 'center'}
                ,{
                    width: twidth * 0.18,
                    fixed: 'right',
                    align: 'center',
    ...
    function editorUser(data) {
        layui.use('layer', function () {
            ...
            humanId=data.id;
            humanDept=data.deptName;
            layer.open({
                title: data.name + ' 用户编辑',
                type: 2,
                area: ['50%', '70%'],
                content: 'human/humanEdit?id=' + data.id,
            });
        });
    }

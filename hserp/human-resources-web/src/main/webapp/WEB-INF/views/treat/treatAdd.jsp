...
<div class='mt'>
    ...
    <form class="layui-form" id="treatAdd">
        ...
        <div class="layui-form-item">
            <div class="layui-input-inline sub" style="margin-left: 150px;">
                <button class="layui-btn" lay-submit="" lay-filter="treatAdd">立即提交</button>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(treatAdd)', function (data) {
            var loadIndex = layer.load();
            var fromData = new FormData($("#treatAdd")[0]);

            $.ajax({
                type: "POST",
                dataType: "json",
                url: 'system/human/api/addTreat',
                data: fromData,
                async: false,
                cache: false,
                contentType: false,

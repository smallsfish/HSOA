...
<script>
    ...
    layui.use('table', function(){
        ...
        layui.use(['element', 'table'], function () {
            ...
            elem: '#test'
            ,url:'system/human/api/getTreatList'
            ,height: 'full-78'
            ,cols: [[
                ...
                if (layEvent === 'del') {
                    layer.confirm('确认删除？', function (index) {
                        ...
                        $.ajax({
                            type: "GET",
                            dataType: "json",
                            url: 'system/human/api/deleteTreat',
                            data: {'id': data.id},
    ...
    function searchSubmit() {
        ...
        searchTable.reload({
            url: 'system/human/api/getTreatList?name=' + userName
        });
    }
    ...
    function editorUser(data) {
        layui.use('layer', function () {
            ...
            treatId = data.id;
            treatDept = data.deptName;
            layer.open({
                title: data.name + ' 用户编辑',
                type: 2,
                area: ['50%', '70%'],
                content: 'treat/treatEdit?id=' + data.id,
            });
        });
    }

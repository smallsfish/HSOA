...
<div class='mt'>
    ...
    <form class="layui-form" id="reserveAdd">
        ...
        <div class="layui-form-item">
            <div class="layui-input-inline sub" style="margin-left: 150px;">
                <button class="layui-btn" lay-submit="" lay-filter="reserveAdd">立即提交</button>
...
<script>
    ...
    layui.use(['form', 'layer', 'laydate'], function () {
        ...
        form.on('submit(reserveAdd)', function (data) {
            var loadIndex = layer.load();
            var fromData = new FormData($("#reserveAdd")[0]);

            $.ajax({
                type: "POST",
                dataType: "json",
                url: 'system/human/api/addStore',
                data: fromData,
                async: false,
                cache: false,
                contentType: false,

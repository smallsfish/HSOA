...
<script>
    ...
    function speed(data) {
        window.parent.createTab({title: data.projectName+'项目进度',isShowClose:true,url:'system/project/getView?viewPage=project/projectSpeed&ki='+data.id});
    }
    ...
    function manager(data) {
        window.parent.createTab({title: data.projectName+'管理',isShowClose:true,url:'system/project/getView?viewPage=project/projectManage&ki='+data.id});
    }
...
<script type="text/html" id="infoToolBar">
    ...
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="speed">进度</a>
</script>
